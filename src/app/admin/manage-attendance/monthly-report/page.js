...
const MonthlyReport = () => {
  ...
  const tileClassName = ({ date }) => {
    ...
    //     moment(log.attendance_date).isSame(currentDate, "day")
    //   ).length === 0
    ...
    //   const isAbsent = attendanceDetails.filter((log) =>
...
// export default withAuth(MonthlyReport, "attendance");


const ManageMonthlyReportPage = withAuth(MonthlyReport, "attendance");

export default ManageMonthlyReportPage;
