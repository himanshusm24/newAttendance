export function generateColors(numColors) {
  const cssNamedColors = [
    ...
    "#00FFFF", "#191970", "#1E90FF", "#20B2AA", "#228B22", "#2E8B57", "#2F4F4F",
    "#32CD32", "#3CB371", "#40E0D0", "#4169E1", "#4682B4", "#483D8B", "#48D1CC",
    "#4B0082", "#556B2F", "#5F9EA0", "#6495ED", "#663399", "#66CDAA", "#696969",
    ...
    "#D2691E", "#D2B48C", "#D3D3D3", "#D8BFD8", "#DA70D6", "#DAA520", "#DC143C",
  ...
  const baseColors = [
    "#525252", "#1565c0", "#00838f", "#2e7d32", "#c62828", "#ef6c00", 
    "#ff5733", "#8e44ad", "#3498db", "#e74c3c", "#f39c12", "#27ae60", 
    "#1abc9c", "#34495e", "#7f8c8d"
  ];
  
  const colors = [...baseColors, ...cssNamedColors];
  ...
  for (let i = baseColors.length + cssNamedColors.length; i < numColors; i++) {
    colors.push(getRandomColor());
  }

  console.log("colors: ", colors.slice(0, numColors));
